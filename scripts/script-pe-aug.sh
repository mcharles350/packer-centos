...
sudo /opt/puppetlabs/puppet/bin/gem install aws-sdk -v 2.2.36 --no-ri --no-rdoc --source http://artifactory.ap.org/api/gems/rubygems
sudo /opt/puppetlabs/puppet/bin/gem install deep_merge -v 1.0.1 --no-ri --no-rdoc --source http://artifactory.ap.org/api/gems/rubygems
sudo /opt/puppetlabs/puppet/bin/gem install r10k -v 2.2.2 --no-ri --no-rdoc --source http://artifactory.ap.org/api/gems/rubygems
sudo /opt/puppetlabs/puppet/bin/gem install macaddr -v 1.7.1 --no-ri --no-rdoc --source http://artifactory.ap.org/api/gems/rubygems
cd /tmp
